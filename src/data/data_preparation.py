...
logger.addHandler(handler)
 ...
 #create a formatter
formatter = logging.Formatter(fmt='%(asctime) - %(name)s - %(levelname)s - %(message)s')
...
if __name__=="__main__":
    ...
    #train and test data save path
    train_filename="train.csv"
    test_filename="test.csv"
    #save path for train and test data
    ...
    filename=["train_filename","test_filename"]
    for filename,path,data in zip(filename,data_paths,data_subsets):
