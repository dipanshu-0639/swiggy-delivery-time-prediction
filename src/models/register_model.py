...
# initialize dagshub
import dagshub
dagshub.init(repo_owner='dipanshu-0639', repo_name='swiggy-delivery-time-prediction', mlflow=True)

# set the mlflow tracking server
mlflow.set_tracking_uri("https://dagshub.com/dipanshu-0639/swiggy-delivery-time-prediction.mlflow")
...
if __name__=="__main__":
    ...
    client=MlflowClient()
    client.transition_model_version_stage(name=registered_model_name,version=registered_model_version,stage="Staging")
